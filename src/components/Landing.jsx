        ...
        <div className="landing">
                <span className="left">
                    <div className="caption1">
                        <hr />
                        <h4>WE ARE TO SERVE NEEDY......</h4>
                    </div>
                    <div className="titles">
                        <div className="caption2">
                            <p>At <span>Arpana,</span> we work towards the betterment of our <span>world</span> </p>
                        </div>
                        ...
                        <div className="btns">
                            <button onClick={() => window.open("https://cutm.ac.in/", "_blank", "noopener noreferrer")} type="button" className="btn btn-outline-info">Know More</button>
