    ...
    return (
        <>
                        ...
                        <div className="col-md-4">
                            <div className="top-bar-right">
                                <div className="social">
                                    <a href="https://x.com/cutmindia?lang=en"><i className="fab fa-x-twitter"></i></a>
                                    <a href="https://www.facebook.com/centurionuniversity/"><i className="fab fa-facebook-f"></i></a>
                                    <a href="https://www.instagram.com/_cutm_/"><i className="fab fa-instagram"></i></a>
                                    <a href="https://www.youtube.com/channel/UCy2a2NdleGSGlEd5FxyOcOA"><i className="fab fa-youtube"></i></a>
                                    <a href="https://in.linkedin.com/school/centurion-university-of-technology-and-management/"><i className="fab fa-linkedin-in"></i></a>
                                </div>
                                {auth && (
            ...
            <div className="navbar navbar-expand-lg bg-dark navbar-dark">
                <div className="container-fluid">
                    <Link to="/" className="navbar-brand">Arpana</Link>
                    ...
                    <div className="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div className="navbar-nav ml-auto">
                            ...
                            {!auth && (
                                <Link to="/login" className={`nav-item nav-link ${path === '/login' ? "active" : ""}`}>Login</Link>
                            )}
